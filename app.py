...
def get_frames_from_video(video_input, video_state):
    ...
    try:
        ...
        while cap.isOpened():
            ...
            save_frame_path=f'D:/OneDrive - Sogang/Sogang/23/papers/Track-Anything-master/result/img/{video_name}/{str(count).zfill(5)}.jpg'
            path=f'D:/OneDrive - Sogang/Sogang/23/papers/Track-Anything-master/result/img/{video_name}'
            #if os.path.exists(save_frame_path):
            #    print(f'{save_frame_path} 이미지가 존재합니다.')
            os.makedirs(path, exist_ok=True)
            if frame is not None:
                if count==0:
                    print("img원본 저장 중 , save_frame_path: ", save_frame_path)
            ...
            if ret == True:
                ...
                break
        print(f'D:/OneDrive - Sogang/Sogang/23/papers/Track-Anything-master/result/img/{video_state["video_name"]}/{str(count).zfill(5)}.jpg save successfully!')
